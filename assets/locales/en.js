export default {
    ...
    transfer: {
        create: {
            ...
            sender_email_placeholder: "example{'@'}domain.com",
            sender_name_placeholder: "John Doe",
            message_label: "Message",
            message_placeholder: "A message for your recipients",
    ...
    admin: {
        ...
        stats: {
            ...
            active_label: "active",
            right_now: "right now",
            total_label: "in total",
            out_of: "out of",
            recipients_label: "recipients",
            chart_users: "New users (last 6 months)",
            chart_transfers: "Transfers created (last 6 months)",
            chart_status: "Transfer status",
            no_data: "No transfers yet.",
        },
        users: {
            title: "Users",
            ...
            toggleRoleConfirm: "Change role for {name}?",
            makeDev: "Make Dev",
        ...
        invitations: {
            title: "Invitations",
            description: "Send an email invitation to join Nimbus.",
            email: "Email address",
            emailPlaceholder: "example{'@'}domain.com",
            message: "Message",
            messagePlaceholder: "A custom message to accompany the invitation…",
            credentialsHint:
                "If filled in, credentials will appear in the email body.",
        ...
        transfers: {
            ...
            filter_all: "All",
            empty: "No transfers.",
            pagination: "Page {page} / {pages} · {total} transfers",
        },
    },
};

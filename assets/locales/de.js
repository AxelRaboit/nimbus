export default {
    ...
    transfer: {
        create: {
            ...
            sender_email_placeholder: "beispiel{'@'}domain.de",
            sender_name_placeholder: "Max Mustermann",
            message_label: "Nachricht",
            message_placeholder: "Eine Nachricht für deine Empfänger",
    ...
    plan: {
        ...
        trialUntil: "Pro-Zugang bis {date}",
        stripeSoon:
    ...
    admin: {
        ...
        stats: {
            ...
            out_of: "von",
            recipients_label: "Empfängern",
            chart_users: "Neue Benutzer (letzte 6 Monate)",
            chart_transfers: "Erstellte Übertragungen (letzte 6 Monate)",
            chart_status: "Status der Übertragungen",
            no_data: "Noch keine Übertragungen.",
        },
        users: {
            title: "Benutzer",
            ...
            toggleRoleConfirm: "Rolle von {name} ändern?",
        ...
        invitations: {
            title: "Einladungen",
            description: "Sende eine E-Mail-Einladung, um Nimbus beizutreten.",
            email: "E-Mail-Adresse",
            emailPlaceholder: "beispiel{'@'}domain.de",
            message: "Nachricht",
            messagePlaceholder: "Eine persönliche Nachricht zur Einladung…",
            credentialsHint:
                "Falls ausgefüllt, erscheinen die Zugangsdaten im E-Mail-Text.",
        ...
        transfers: {
            ...
            filter_all: "Alle",
            empty: "Keine Übertragungen.",
            pagination: "Seite {page} / {pages} · {total} Übertragungen",
        },
    },
};
